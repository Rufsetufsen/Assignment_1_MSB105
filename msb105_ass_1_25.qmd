...
For readers interested in a broader perspective on the topic, I've compiled a list of several other contributions of note.

@ioannidis2005b provides a disturbing argument on how most research claims are likely false, and the implications of this.

For those wishing to take the first steps towards robust an reliable science, @ellis2017 provides guidelines and general principles on sharing data for collaboration.
